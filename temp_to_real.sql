CREATE OR REPLACE PROCEDURE _import.create_real_gtfs_feeds_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
--CREATE OR REPLACE PROCEDURE _import.create_real_gtfs_extra_attributes_table()
--LANGUAGE plpgsql
--AS $$
--BEGIN
--
...
END;
$$;
-- CALL _import.create_real_agency_table()

CREATE OR REPLACE PROCEDURE _import.create_real_feed_info_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_feed_info_table()

CREATE OR REPLACE PROCEDURE _import.create_real_translations_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_translations_table()

CREATE OR REPLACE PROCEDURE _import.create_real_networks_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_networks_table()

CREATE OR REPLACE PROCEDURE _import.create_real_fare_media_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_fare_media_table()

CREATE OR REPLACE PROCEDURE _import.create_real_shapes_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_shapes_table()

CREATE OR REPLACE PROCEDURE _import.create_real_calendar_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_calendar_table()

CREATE OR REPLACE PROCEDURE _import.create_real_levels_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_levels_table()

CREATE OR REPLACE PROCEDURE _import.create_real_areas_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_areas_table()

CREATE OR REPLACE PROCEDURE _import.create_real_stops_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_stops_table()

CREATE OR REPLACE PROCEDURE _import.create_real_routes_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_routes_table()

CREATE OR REPLACE PROCEDURE _import.create_real_calendar_dates_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_calendar_dates_table()

CREATE OR REPLACE PROCEDURE _import.create_real_fare_attributes_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_fare_attributes_table()

CREATE OR REPLACE PROCEDURE _import.create_real_fare_rules_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_fare_rules_table()

CREATE OR REPLACE PROCEDURE _import.create_real_trips_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_trips_table()

CREATE OR REPLACE PROCEDURE _import.create_real_stop_times_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_stop_times_table()

CREATE OR REPLACE PROCEDURE _import.create_real_transfers_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_transfers_table()

CREATE OR REPLACE PROCEDURE _import.create_real_timeframes_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_timeframes_table()

CREATE OR REPLACE PROCEDURE _import.create_real_fare_products_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_fare_products_table()

CREATE OR REPLACE PROCEDURE _import.create_real_fare_leg_rules_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_fare_leg_rules_table()

CREATE OR REPLACE PROCEDURE _import.create_real_fare_transfer_rules_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_fare_transfer_rules_table()

CREATE OR REPLACE PROCEDURE _import.create_real_stop_areas_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_stop_areas_table()

CREATE OR REPLACE PROCEDURE _import.create_real_route_networks_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_route_networks_table()

CREATE OR REPLACE PROCEDURE _import.create_real_frequencies_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_frequencies_table()

CREATE OR REPLACE PROCEDURE _import.create_real_pathways_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_pathways_table()

CREATE OR REPLACE PROCEDURE _import.create_real_attributions_table()
LANGUAGE plpgsql
AS $$
BEGIN
...
END;
$$;
-- CALL _import.create_real_attributions_table()

----------------------------------------------------------------------------------------------------------------------------

CREATE OR REPLACE PROCEDURE _import.insert_into_real_tables()
LANGUAGE plpgsql
AS $$
BEGIN
